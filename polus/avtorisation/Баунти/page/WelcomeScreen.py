...
class WelcomeScreen(QDialog):
    ...
    def __init__(self):
        ...
        self.pushButton.clicked.connect(self.signupfunction) # нажати на кнопку и вызов функции
    ...
    def signupfunction(self): # создаем функцию регистрации
        ...
        user = self.lineEdit.text() # создаем пользователя и получаем из поля ввода логина введенный текст
        ...
        if len(user)==0 or len(password)==0: # если пользователь оставил пустые поля
            ...
            conn = sqlite3.connect("borsh.db") # подключение к базе данных в () изменить на название своей БД
